...
public class AddColorBeltController implements Initializable  {
	...
	@FXML
	public void addColorBeltStudent (ActionEvent event1) throws SQLException
	{
		...
		String degree = beltColor.getText();
		
		String addStudent = "INSERT INTO Students (fname,lname,guardian,age,address,phoneNumber,email) VALUES(?,?,?,?,?,?,?)";
		String addColorBelt = "INSERT INTO ColorBelt (fName,lName,BeltColor) VALUES(?,?,?)";
        try {
